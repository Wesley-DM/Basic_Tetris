...
public class Mino {
	  ...
	  //left wall
		...
		//bottom wall
			...
			for (int i = 0; i < PlayManager.staticblocks.size(); i++) {
				...
				for(int ii= 0 ; ii < b.length; ii++) {
					if(b[ii].x + Block.SIZE == targetX && b[ii].x == targetY) {
						rightCollision = true;
	...
	public void update() {
	  ...
	  KeyHandler.leftPressed = false;
		...
		autoDropCounter++; // the counter increase in each frame
	
		System.out.println("autoDropCounter"+autoDropCounter );
	}
